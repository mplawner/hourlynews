...
def post_status_with_audio(audio_path):
    ...
    status_text = f"The {hour} update from Israel Today: Ongoing War Report brought to you by Noa Levi on the ongoing war between Israel and Hamas following the October 7th massacre of Israeli civilians.\n\nPodcast Details: https://www.spreaker.com/show/israel-today-ongoing-war-report \n\nListen and Subscribe on your favorite podcast app.\n\n#Israel #Hamas #Gaza #Palestine"
...
# To post an update, simply call post_status_with_audio() with the path to your audio file.
